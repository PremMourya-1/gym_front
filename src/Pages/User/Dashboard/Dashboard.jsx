...
import { FaUsers, FaUserPlus, FaRupeeSign, FaCalendarDay, FaUserTimes, FaVenusMars, FaExclamationCircle, FaBell, FaCog } from "react-icons/fa";
...
function Dashboard() {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* 🔥 Top Summary Cards */}
      {/* 🔥 Top Summary Cards */}
      <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 grid-cols-4 gap-3">

        {/* Total Clients */}
        <Card className={`dashboardCard relative border-l-41 ${borders[0]} hover:-translate-y-1 hover:shadow-2xl transition-transform`}>
          <Link to={'clients/all'}>
        ...
        <Card className={`dashboardCard relative border-l-41 ${borders[1]}`}>
          ...
          <p className="text-sm uppercase font-semibold">This Month Registered</p>
          <p className="text-sm mb-1">New Clients</p>
          <h2 className="text-xl font-semibold">{d?.thisMonthRegistered || 0}</h2>
        </Card>
        ...
        <Card className={`dashboardCard relative border-l-41 ${borders[2]}`}>
          ...
          <p className="text-sm uppercase font-semibold">{`Today's`} Registered</p>
          <p className="text-sm mb-1">New Clients</p>
        ...
        <Card className={`dashboardCard relative border-l-41 ${borders[3]}`}>
          ...
          <p className="text-sm uppercase font-semibold">This Month Collection</p>
        ...
        <Card className={`dashboardCard relative border-l-41 ${borders[4]}`}>
          ...
          <p className="text-sm uppercase font-semibold">{`Today's`} Collection</p>
          <p className="text-sm mb-1">Revenue</p>
          <h2 className="text-xl font-semibold text-[var(--success)]">
            ₹ {d?.todayCollection || 0}
          </h2>
        ...
        {/* Expired */}
        <Card className={`dashboardCard relative border-l-41 ${borders[5]} hover:-translate-y-1 hover:shadow-2xl transition-transform`}>
        ...
        {/* Pending Payments */}
        <Card className={`dashboardCard relative border-l-41 ${borders[6]} hover:-translate-y-1 hover:shadow-2xl transition-transform`}>
      ...
      <div className="grid grid-cols-2 md:grid-cols-1 gap-4">
        ...
        <Card className="p-4">
          ...
          <div className="">
            {d?.todaysRenewals?.length ? d.todaysRenewals.map((p, i) => {
              ...
              return (
                <div key={i} className="flex items-center last:pb-0 last:mb-0 last:border-none justify-between pb-4 mb-4 border-b border-color">
              ...
              <p className="text-sm text-[var(--text-light)]">No payments today</p>
            )}
          </div>
        </Card>
        ...
        <Card className="p-4">
          ...
          <div className="space-y-4">
            ...
            {d?.planDistribution?.map((p, i) => {
              ...
              return (
                <div key={i} className="mb-2 pb-2 border-color last:pb-0 border-b  last:!border-0 ">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <p className="text-sm font-semibold text-[var(--text)]">
                      ₹ {p.revenue || 0}
                      <span className="text-xs text-[var(--text-light)]"> /mo</span>
                    </p>
        ...
        <Card className="p-4">
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <h3 className="font-semibold text-[var(--text)]">     Expired Clients</h3>
